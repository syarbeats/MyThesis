...
// Uses same Google Map API key than ../qtmobility/examples/fetchgooglemaps example
const QString
...
GoogleMapLoader::GoogleMapLoader(QObject *parent) :
    QObject(parent)
{
...
void GoogleMapLoader::GoogleMapLoaderImage(const QSize& size, qreal yourLong, qreal yourLat, qreal friendLong,
    qreal friendLat)
{
    QString url;
...
void GoogleMapLoader::handleNetworkData(QNetworkReply *reply)
{
